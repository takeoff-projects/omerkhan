---
title: "Merge Request Guidelines"
linkTitle: "Merge Request Guidelines"
date: 2018-07-22
weight: 8
description: >
...
{{% pageinfo %}}
This page is a work in progress. Help us add to this page by [contributing to this page](https://github.com/TakeoffTech/engineering-handbook/issues).
{{% /pageinfo %}}


# Merge requests workflow

We welcome merge requests from everyone on the engineering team, with fixes and improvements
to Takeoff code, tests, and documentation. The issues that are specifically suitable
...
when you are working on it, a Takeoff Inc. team member may take over the merge request
...
If you are new to Takeoff development (or web development in general), see the
[how to contribute](index.md#how-to-contribute) section to get started with
some potentially easy issues.

To start developing Takeoff, download the [Takeoff Development Kit](https://Takeoff.com/Takeoff-org/Takeoff-development-kit)
...
1. [Fork](../../user/project/repository/forking_workflow.md) the project into
   your personal namespace (or group) on Takeoff.com.
...
1. Submit a merge request (MR) to the `main` branch in the main Takeoff project.
...
1. UI changes should use available components from the Takeoff Design System.
...
1. If your merge request introduces changes that require additional steps when
   installing Takeoff from source, add them to `doc/install/installation.md` in
   the same merge request.
1. If your merge request introduces changes that require additional steps when
   upgrading Takeoff from source, add them to
...
from the [core team](https://about.Takeoff.com/community/core-team/) or one of the
[merge request coaches](https://about.Takeoff.com/company/team/). When having your code reviewed
...
[minimum viable change](https://about.Takeoff.com/handbook/product/#the-minimally-viable-change)
...
more important to Takeoff than having a minimal commit log. The smaller an MR is,
...
- Use issues and merge requests' full URLs instead of short references,
  as they are displayed as plain text outside of Takeoff.
- The merge request should not contain more than 10 commit messages.
- The commit subject should contain at least 3 words.

**Important notes:**

- If the guidelines are not met, the MR may not pass the [Danger checks](https://Takeoff.com/Takeoff-org/Takeoff/-/blob/master/danger/commit_messages/Dangerfile).
...
1. The merge request meets the Takeoff [definition of done](#definition-of-done), below.

## Definition of done

If you contribute to Takeoff please know that changes involve more than just
...
1. [Secure coding guidelines](https://Takeoff.com/Takeoff-com/gl-security/security-guidelines) have been followed.
...
1. Create an issue in the [infrastructure issue tracker](https://Takeoff.com/Takeoff-com/gl-infra/infrastructure/-/issues) to inform the Infrastructure department when your contribution is changing default settings or introduces a new setting, if relevant.
1. Confirmed to be working in the [Canary stage](https://about.Takeoff.com/handbook/engineering/#canary-testing) with no new [Sentry](https://about.Takeoff.com/handbook/engineering/#sentry) errors or on Takeoff.com once the contribution is deployed.
1. Added to the [release post](https://about.Takeoff.com/handbook/marketing/blog/release-posts/),
   if relevant.
1. Added to [the website](https://Takeoff.com/Takeoff-com/www-Takeoff-com/blob/master/data/features.yml), if relevant.
1. [Black-box tests/end-to-end tests](../testing_guide/testing_levels.md#black-box-tests-at-the-system-level-aka-end-to-end-tests)
   added if required. Please contact [the quality team](https://about.Takeoff.com/handbook/engineering/quality/#teams)
   with any questions.
1. The new feature does not degrade the user experience of the product.

Contributions do not require approval from the [Product team](https://about.Takeoff.com/handbook/product/product-processes/#Takeoff-pms-arent-the-arbiters-of-community-contributions).

## Dependencies

If you add a dependency in Takeoff (such as an operating system package) please
consider updating the following, and note the applicability of each in your merge
request:

1. Note the addition in the [release blog post](https://about.Takeoff.com/handbook/marketing/blog/release-posts/)
   (create one if it doesn't exist yet).
1. [The upgrade guide](../../update/upgrading_from_source.md).
1. The [Takeoff Installation Guide](../../install/installation.md#1-packages-and-dependencies).
1. The [Takeoff Development Kit](https://Takeoff.com/Takeoff-org/Takeoff-development-kit).
1. The [CI environment preparation](https://Takeoff.com/Takeoff-org/Takeoff/-/blob/master/scripts/prepare_build.sh).
1. The [Omnibus package creator](https://Takeoff.com/Takeoff-org/omnibus-Takeoff).
1. The [Cloud Native Takeoff Dockerfiles](https://Takeoff.com/Takeoff-org/build/CNG)
...
showing up everywhere](https://Takeoff.com/Takeoff-org/Takeoff/-/merge_requests/18985))
